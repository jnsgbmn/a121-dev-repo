      ...
      <div>
        <div className=" gap-8  mt-[100px] max-w-[800px] mx-auto grid md:grid-cols-2">
          ...
          <div className=" flex flex-col justify-center">
            ...
            <p className=" text-sm font-p ">
              Master Planning of Town Halls, Urban Subdivisions, Resorts, and
              Industrial Plants
            </p>
          </div>
        </div>
        <div className="mt-[100px] max-w-[800px] mx-auto grid md:grid-cols-2">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm  font-p ">
              Concept Design, Floor Plans and Perspectives of Buildings. House,
              Store, and Office Interior Fit-outs
            </p>
          </div>
          <img src={img1} className=" pr-5  mx-auto my-4 w-[184px][" alt="/" />
        </div>
        ...
        <div className=" gap-8  mt-[100px] max-w-[800px] mx-auto grid md:grid-cols-2">
          ...
          <div className=" flex flex-col justify-center">
            ...
            <p className=" text-sm font-p ">
              High Voltage and Low Voltage Design, Building Plumbing and
              Sanitary Design
            </p>
          </div>
        </div>
        ...
        <div className="mt-[100px] max-w-[800px] mx-auto grid md:grid-cols-2">
          ...
          <img src={img3} className=" pr-5  mx-auto my-4 w-[184px][" alt="/" />
        </div>

        <div className="gap-8 mt-[100px] max-w-[800px] mx-auto grid md:grid-cols-2">
          <img src={img4} className=" pr-5  mx-auto my-4 w-[184px][" alt="/" />
          <div className=" flex flex-col justify-center">
            <h1 className=" md:text-2xl sm:text-3xl font-h1  py-2">ICT</h1>
            <p className="text-sm font-p ">
